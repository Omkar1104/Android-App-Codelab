...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.imgSampleFour -> {
                setViewAndDetect(getSampleImage(R.drawable.img_meal_four))
            }
        }
    }
    ...
    private fun runObjectDetection(bitmap: Bitmap) {
        ...
        val detector = ObjectDetector.createFromFileAndOptions(
            ...
            "lite-model_efficientdet_lite0_detection_metadata_1.tflite", // must be same as the filename in assets folder
            options
        )
